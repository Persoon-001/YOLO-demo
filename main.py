...
# Get the maximum supported resolution, if possible with the webcam provided.
...
# model = YOLO("yolo-Weights/yolo11s.pt")    # Small
# model = YOLO("yolo-Weights/yolo11n.pt")    # Nano
